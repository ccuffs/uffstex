...
\usepackage[
  ...
  % para mais informações sobreo estilo abnt
  % do biblatex: https://github.com/abntex/biblatex-abnt
]{biblatex}
...
Codar um array de sufixos é mais fácil que uma árvore de sufixos \cite[253]{halim3rd}.
...
% se utilizar o pacote biblatex, como neste exemplo:
\printbibliography[heading=abnt]
% se utilizar o abntex2cite, consultar a documentação:
