...
\data{\hoje}
\orientador{Prof.\ Dr.\ Fulano da Computação}
\coorientador{Prof.\ Dr.\ Beltrano da Computação}
\tipotrabalho{Trabalho de conclusão de curso (graduação)}
\palavrachave{Palavra-chave 1}
\palavrachave{Palavra-chave 2}
\palavrachave{Palavra-chave 3}
\palavrachave{Palavra-chave 4}
\palavrachave{Palavra-chave 5}
...
\imprimircip[endereco@dominio.com.br]
